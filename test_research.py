...
num_cats, scale, trainS, testS, obs_key, action_key, name_size, train_act, test_act, is_image, is_text, decoders, loaded_model = 256, 1, 'train', 'test', 'image', 'label', '', tf.constant([[0]]), tf.constant([[0]]), False, False, None, False
